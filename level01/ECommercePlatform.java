...
// Abstract class level01.Product
abstract class Product {
    ...
    public void displayDetails() {
        System.out.println("level01.Product ID: " + productId);
        System.out.println("Name: " + name);
        System.out.println("Price: " + price);
    }
}

// Interface level01.Taxable
interface Taxable {
    double calculateTax();
    String getTaxDetails();
}

// level01.Electronics Class
...
public class ECommercePlatform {
    public static void main(String[] args) {
        ...
        products.add(new Electronics(1, "Laptop", 1000, 10, 18));
        products.add(new Clothing(2, "T-Shirt", 500, 20, 5));
        products.add(new Groceries(3, "Milk", 50, 5));
