...
abstract class Employee{
    ...
    public void displayDetails(){
        System.out.println("level01.Employee ID: "+employeeID+" Name: "+name+" baseSalary "+baseSalary);
    }
}
...
class FullTimeEmployee extends Employee implements Department{
    ...
    public String getDepartmentDetails() {
        return "level01.Department :"+department;
    }
...
// Subclass level01.PartTimeEmployee
...
public class EmployeeManagement {
    public static void main(String[] args) {
        ...
        // Add level01.FullTimeEmployee and level01.PartTimeEmployee
        FullTimeEmployee fte = new FullTimeEmployee(1, "Alice", 50000.0, 10000.0);
        fte.assignDepartment("Engineering");

        PartTimeEmployee pte = new PartTimeEmployee(2, "Bob", 20000, 20, 100);
